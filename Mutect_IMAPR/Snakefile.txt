...
#rna_dict = {pid: (rid, rseq) for pid, rid, rseq in zip(RNA_TUMOR.PATIENT_ID, RNA_TUMOR.RNA_ID, RNA_TUMOR.RNA_SEQ)}
...
intersecting_patients = set(rna_dict.keys()).intersection(dna_tumor_dict.keys())#, dna_norm_dict.keys())
...
rule run_pipeline:
    ...
    shell:
        ...
        #Temporarily copy the other way around
        #"mkdir -p {params.tmp}/IMAPR/; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/IMAPR/{params.IMAPR_FINAL_VARIANT} {params.tmp}/IMAPR/{params.IMAPR_FINAL_VARIANT}; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/IMAPR/{params.IMAPR_FINAL_VARIANT}.tbi {params.tmp}/IMAPR/{params.IMAPR_FINAL_VARIANT}.tbi; "
        #Temporarily copy end
        ...
        #Temporarily Copy the other way around
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/Mutect/{params.Mutect_VARIANT} {params.tmp}/{params.Mutect_VARIANT}; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/Mutect/{params.Mutect_VARIANT}.stats {params.tmp}/{params.Mutect_VARIANT}.stats; "
        # Temporarily copy end 
        ...
        #Temporarily copy the other way around
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/Mutect/{params.Mutect_VARIANT_FILT} {params.tmp}/{params.Mutect_VARIANT_FILT}; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/Mutect/{params.Mutect_VARIANT_FILT}.tbi {params.tmp}/{params.Mutect_VARIANT_FILT}.tbi; "
        #Temporarily copy end
        ...
        #Temporarily copy the other way around
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/{params.TRUE_VCF_SUB}.gz {params.tmp}/{params.TRUE_VCF_SUB}.gz; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/{params.TRUE_VCF_SUB}.gz.tbi {params.tmp}/{params.TRUE_VCF_SUB}.gz.tbi; "
        #Temporarily copy end
        ...
        #Temporarily copy the other way around
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/{params.TRUE_VCF_SUB_NORM}.gz {params.tmp}/{params.TRUE_VCF_SUB_NORM}.gz; "
        #"cp {config[OUTDIR]}/{wildcards.PATIENT_ID}/{params.TRUE_VCF_SUB_NORM}.gz.tbi {params.tmp}/{params.TRUE_VCF_SUB_NORM}.gz.tbi; "
        #Temporarily copy end
